...
execute as nduc03 if entity @s[nbt={Inventory: [{id: "minecraft:shears", Slot: 103b, tag: {CustomModelData: 11}}]}] unless entity @s[nbt={ActiveEffects: [{Id: 21b}]}] run effect give @s health_boost 999999 0 true
execute as nduc03 unless entity @s[nbt={Inventory: [{id: "minecraft:shears", Slot: 103b, tag: {CustomModelData: 11}}]}] run effect clear @s health_boost
